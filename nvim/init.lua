function RunFile()
  ...
  local ext = vim.fn.split(filename, '%.')[2]
  if ext == 'py' then
    vim.cmd 'split | resize 10 | term python %'
  else
...
--------------------- MY KEYMAPS ------------------------------------
--execute RunFile with ctrl+shift+n
vim.keymap.set('n', '<C-S-n>', '<cmd>lua RunFile()<CR>', { desc = 'RunFile' })
